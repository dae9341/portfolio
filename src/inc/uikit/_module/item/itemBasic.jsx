        ...
        return(
            <div className={`m-itemBasic`}>
                ...
                <div className={`m-itemBasic__image`}>
                    ...
                    <div className={`a-itemZzim`} data-zzim="on">
                        <a className={`a-itemZzim__btn`} href={`javascript:;`} onClick={()=> {this.handleClick(event)}} ><span className={``}>찜하기</span></a>
                    </div>
                </div>
                <div className={`m-itemBasic__content`}>
                    ...
                    <div className={`a-itemPrice`}>
                        <span className={`a-itemPrice__percent`}>60%</span>
                        <span className={`a-itemPrice__now`}>12,900</span>
                        <span className={`a-itemPrice__origin`}>32,900</span>
                    </div>
                    ...
                    <div className={`a-itemBenefit`}>
                        <div className={`a-itemBenefit__freeDeli`}>무료배송</div>
