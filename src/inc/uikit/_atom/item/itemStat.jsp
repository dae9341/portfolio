...
<div class="a-itemStat">
    <span class="a-itemStat__star">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
             width="1280.000000pt" height="1216.000000pt" viewBox="0 0 1280.000000 1216.000000"
             preserveAspectRatio="xMidYMid meet">
            <g transform="translate(0.000000,1216.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
    ...
    <span class="a-itemStat__score">4.6</span>
    <span class="a-itemStat__review">리뷰 <span class="a-itemStat__review__count">225</span>건</span>
</div>