...
<head>
    ...
    <link rel="stylesheet" href="/../src/css/kdh_vendor.css">
    <link rel="stylesheet" href="/../src/css/kdh_base.css">
    <link rel="stylesheet" href="/../src/css/kdh_common.css">
...
<style>
    ...
    .wsgFrame__layout__title{font-size:14px; font-weight: bold; background: #004444; color: #fff; padding: 2px; margin-bottom: 5px;}
</style>
<div class="kdh">
    <div class="content">